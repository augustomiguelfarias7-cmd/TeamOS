...
- **Login flow**: validates e-mail-only first-run login, greeting, and local PIN creation before opening the home screen.
...
├── login.py       # e-mail login, greeting, and PIN setup flow
